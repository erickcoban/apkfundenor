...
public class AgregarHuertos extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener list_buenasPracticas = new View.OnClickListener() {
            @Override
        ...
        View.OnClickListener list_prodOrga = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                switch(view.getId()) {
                    case R.id.rb_noPO:
        ...
        View.OnClickListener list_practAgua = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                switch(view.getId()) {
                    case R.id.rb_noPA:
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btnAgregarId:
                ...
                Intent main = new Intent(AgregarHuertos.this, MyActivityHuertos.class)
