...
public class ModificarParticipante extends Activity implements OnClickListener {
    ...
    SQLControladorParticipante dbcon;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        // TODO Auto-generated method stub
        super.onCreate(savedInstanceState);
        setContentView(R.layout.modificar_participante);

        dbcon = new SQLControladorParticipante(this);
