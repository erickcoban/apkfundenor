...
public class AgregarAmbiente extends Activity implements OnClickListener {
    ...
    //Asignación atributos en las variables declaradas
        ...
        OnClickListener list_paredVivienda = new OnClickListener() {
            @Override
        ...
        OnClickListener list_techoVivienda = new OnClickListener() {
            @Override
            public void onClick(View view) {
                switch(view.getId()) {
                    case R.id.rb_lamina:
        ...
        OnClickListener list_pisoVivienda = new OnClickListener() {
            @Override
            public void onClick(View view) {
                switch(view.getId()) {
                    case R.id.rb_tierra:
        ...
        OnClickListener list_divisionesVivienda = new OnClickListener() {
            @Override
            public void onClick(View view) {
                switch(view.getId()) {
                    case R.id.rb_no:
        ...
        OnClickListener list_accesoAgua = new OnClickListener() {
            @Override
            public void onClick(View view) {
                switch(view.getId()) {
        ...
        OnClickListener list_tipoAlmacen = new OnClickListener() {
            @Override
            public void onClick(View view) {
                switch(view.getId()) {
                    case R.id.rb_tinaco:
        ...
        OnClickListener list_tipoPurificacion = new OnClickListener() {
            @Override
            public void onClick(View view) {
                switch(view.getId()) {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btnAgregarId:
                ...
                Intent main = new Intent(AgregarAmbiente.this, MyActivity.class)
