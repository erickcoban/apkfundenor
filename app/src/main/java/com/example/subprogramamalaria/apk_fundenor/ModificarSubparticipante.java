...
public class ModificarSubparticipante extends Activity implements OnClickListener {
    ...
    SQLControladorSubparticipante dbcon;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        // TODO Auto-generated method stub
        super.onCreate(savedInstanceState);
        setContentView(R.layout.modificar_subparticipante);

        dbcon = new SQLControladorSubparticipante(this);
    ...
    public void returnHome() {
        ...
        Intent home_intent = new Intent(getApplicationContext(),
                MyActivityParticipante.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
